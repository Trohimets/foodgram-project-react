# Generated by Django 2.2.19 on 2022-05-17 12:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=256, verbose_name='Цвет обложки')),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
            fields=[
                ...
                ('picture', models.IntegerField(verbose_name='ЗАГЛУШКА')),
                ...
                ('ingridients', models.ManyToManyField(help_text='Выберите ингридиенты', related_name='ingridients', to='recipes.Ingridient', verbose_name='Ингридиент')),
                ('tag', models.ManyToManyField(help_text='Выберите тэги', related_name='tags', to='recipes.Tag', verbose_name='Тэг')),
            ],
        ),
    ]
